// ================================================================
// FILE: js/api.js — VERSIONE DEFINITIVA
...
const API = {
  ...
  async call(action, data) {
    ...
    try {
      ...
      catch (e) { return { success: false, error: 'Risposta server non valida.' }; }
    } catch (err) {
      if (err.message && err.message.includes('Failed to fetch'))
        return { success: false, error: 'Impossibile contattare il server.' };
      return { success: false, error: err.message };
  ...
  async deleteCliente(id)                       { return this.call('toggleStatoCliente', { id }); },

  // ALBERO CLIENTE / CANTIERI — tutti i nomi possibili
  ...
  async getCantieri(idCliente)                  { return this.call('getAlberoCliente', { idCliente }); },
  async getAlberoClienti(idCliente)             { return this.call('getAlberoCliente', { idCliente }); },
  ...
  async deleteCantiere(id)                      { return this.call('toggleStatoCantiere', { id }); },

  // RILIEVI — tutti i nomi possibili
  ...
  async getPosizioni(idRilievo)                 { return this.call('getPosizioniSerr',      { idRilievo }); },
  async createPosizioneSerr(data)               { return this.call('createPosizioneSerr',   { data }); },
  async createPosizione(data)                   { return this.call('createPosizioneSerr',   { data }); },
  async updatePosizioneSerr(id, data)           { return this.call('updatePosizioneSerr',   { id, data }); },
  async updatePosizione(id, data)               { return this.call('updatePosizioneSerr',   { id, data }); },
  ...
  async getReportAccessori(idRilievo)           { return this.call('calcolaReportAccessori',    { idRilievo }); },
  async getReportPosa(idRilievo, tipo)          { return this.call('calcolaReportPosa',         { idRilievo, tipo }); },
